...
class SignalGenerator:
    ...
    def make_decision(self, pairs: List[CointegratedPair]) ->List[Decision]:
        ...
        current_posn_pairs = [(pos.asset1, pos.asset2) for pos in positions]
        coint_pairs = [pa.pair for pa in pairs]
        ...
        print("emergency-threshold close count: ", self.emergency_close_count)
